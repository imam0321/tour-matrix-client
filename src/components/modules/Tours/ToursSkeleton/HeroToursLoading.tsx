...
export default function HeroToursLoading() {
  return (
    <section className="relative h-40 md:h-40 flex items-center justify-center overflow-hidden animate-pulse">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-4 space-y-4">
        <Skeleton className="h-10 md:h-12 w-2/3 mx-auto rounded-md" />
